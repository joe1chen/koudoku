...
module Koudoku
  class InstallGenerator < Rails::Generators::Base
    ...
    def install
      ...
      generate("model", "subscription stripe_id:string plan_id:integer last_four:string coupon_id:integer card_type:string current_price:float #{subscription_owner_model}_id:integer quantity:integer")
